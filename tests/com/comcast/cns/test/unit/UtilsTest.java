...
public class UtilsTest {
    ...
    public void testMapEquals() {
        ...
        if (com.comcast.plaxo.cmb.common.util.Util.isMapsEquals(m1, null)) {
            fail("Should have failed");
        }
        if (com.comcast.plaxo.cmb.common.util.Util.isMapsEquals(null, m1)) {
            fail("Should have failed");
        }
        if (!com.comcast.plaxo.cmb.common.util.Util.isMapsEquals(m1, m2)) {
    ...
    public void testSubList() {
        ...
        List<List<String>> lofl = com.comcast.plaxo.cmb.common.util.Util.splitList(list, 3);
        if (lofl.size() != 4) {
        ...
        lofl = com.comcast.plaxo.cmb.common.util.Util.splitList(list2, 3);
        if (lofl.size() != 1) {
