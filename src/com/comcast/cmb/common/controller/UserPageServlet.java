...
public class UserPageServlet extends AdminServletBase {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (user != null) {
			...
			out.println("<tr><td><b>Links:</b></td><td><a href='"+response.encodeURL(AdminServlet.cnsAdminBaseUrl + "CNSUser")+"?userId="+userId+"'>CNS</a>&nbsp;&nbsp;&nbsp;<a href='"+response.encodeURL(AdminServlet.cqsAdminBaseUrl+"CQSUser")+"?userId="+userId+"'>CQS</a></td></tr>");
